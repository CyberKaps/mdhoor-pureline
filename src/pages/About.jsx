...
import { Leaf, Heart, Sprout, GlassWater } from 'lucide-react'
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg text-center max-w-3xl mx-auto text-brown-700 mb-12">
          Welcome to Madhoor Pureline, where purity meets health. Founded in 2024, we are committed to crafting wholesome, chemical-free food products that nourish both body and soul.
        </p>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 mt-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span><strong>Zero percent Water Adding</strong> — During processing we don't add any Moisture content or Water</span>
              </li>
            </ul>
