const ComparisonTable = () => {
  return (
    <section className="bg-[#fefae0] py-20 px-6 md:px-16 text-olive">
      <h2 className="text-4xl font-bold text-center mb-8 raleway-heading">Why Choose Madhoor?</h2>
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-[#95be47] text-center">
          ...
          <tbody className="bg-white">
            <tr>
              <td className="py-3 px-4">Cold Pressed</td>
              <td>✅</td>
              <td>❌</td>
            </tr>
            ...
            <tr className="bg-[#fefae0]">
              <td className="py-3 px-4">Traditional Process</td>
              <td>✅</td>
              <td>❌</td>
            </tr>
            <tr>
